...
<body>
    <!--팝업 열기 -->
        ...
        <div id="pop_info_1" class="pop_wrap" style="display:none;"><!--팝업내용-->
            <div class="pop_inner" id = "pop_inner">
                <p class="dsc"><!--팝업글-->
                    <span class="star"> <!--별점 부여-->
                        ★★★★★
                        <span>★★★★★</span>
                        <input type="range" oninput="drawStar(this)" value="1" step="1" min="0" max="10">
                    </span><!-- 별점 부여끝-->
                
                    <div class="section"><!-- 리뷰 -->       
                        <input id="hid_contents_deny" type="hidden" value="">
                        <div style="position:relative">
                            <div class="title">리뷰.<span class="deny fc-red"></span></div>
                            <div style="position:absolute;right:0px;top:0px;"></div>
                            <div class="clear"></div>
                        </div>
                
                        <textarea id="txt_contents" name="content" class="fs-13" placeholder="리뷰를 남겨주세요."
                        ...
                        <div style="padding-top:5px;">
                            ...
                            <div class="fr">
                                ...
                                <span class="lbl_limit">1000</span><!--리뷰길이제한-->
                            </div>                
                            <div class="clear"></div>
                        </div>
                    </div> 
