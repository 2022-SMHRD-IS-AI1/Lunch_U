						...
						<table>
							...
							<tr>
								...
								<td><input type="checkbox" id="snackbar" name="category"
									...
									name="category" value="닭요리"> <label for="chickendish"
									...
									value="양식"> <label for="westernfood"
							...
							<tr>
								<td colspan="2">
									<input type="submit" value="수정" style="text-align: center">
								</td>
							</tr>
						</table>
					</form>
